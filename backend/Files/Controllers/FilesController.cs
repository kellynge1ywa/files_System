...
public class FilesController:ControllerBase
{
    ...
    private readonly Ifile _filesServices;
    private readonly Ifolder _folderServices;
    private readonly ResponseDto _response;
    public FilesController(IMapper imapper, Ifile filesServices, Ifolder folderServices)
    {
        _imapper = imapper;
    ...
    public async Task<ActionResult<ResponseDto>> FileUpload([FromForm] UploadFileDto fileDto, Guid folderId)
    {
        try
        {
            ...
            var folder = await _folderServices.GetFolder(folderId);
            if (folder == null)
            {
